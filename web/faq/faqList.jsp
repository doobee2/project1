...
<head>
    ...
    <style>
        .faqlist li { padding-top:10px; padding-bottom:10px; line-height: 2; font-size: 18px; }
        .faqlist li .ans {
            padding: 20px;
...
<div class="container">
    ...
    <div  class="contents" id="contents">
        ...
        <section class="page" id="page1">
            <div class="page_wrap">
                <h2 class="page_tit">자주묻는질문(FAQ)</h2>
                <br><br><hr><br><br>

                <div class="tel">
                    <img src="/image/sub/tel.png">
                </div>
